...
local ohInstance3 = workspace.Anthills[Chosen].Platform
...
Convert = function()
	...
	game:GetService("ReplicatedStorage").Events.Server_Function:InvokeServer(ohString1, ohString2, ohInstance3)
...
Gather = function()
	...
	Character:PivotTo(Field.Position)
